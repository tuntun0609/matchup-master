...
export default function EightStrongSecondRound() {
  const [players, setPlayers] = useAtom(eightStrongSecondRoundPlayersAtom)
  ...
  const handleStartGame = () => {
    ...
    router.push('/playground/eight-strong-second-round')
  }
